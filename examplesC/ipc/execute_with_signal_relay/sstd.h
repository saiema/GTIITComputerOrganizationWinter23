...
#define ERROR_FORMAT_NULL 200
#define ERROR_VALUES_NULL 201

#define ERROR_SYSTEM_NO_FILE 203
#define ERROR_SYSTEM_NO_ACCESS 204
#define ERROR_SYSTEM_NULL_FILE 205
#define ERROR_SYSTEM_EXECUTION_FAILED 206
#define ERROR_SYSTEM_CHILD_INVALID_EXIT 207
